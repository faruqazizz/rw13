<div class="row">
    <div class="col-md-12 col-xl-10 mx-auto animated fadeIn delay-2s">
        <div class="card m-b-30">
            ...
            <div class="card-body">
                <form action="<?=$action?>" id="form" autocomplete="off">
                    ...
                    <div class="form-group d-none">
                        ...
                        <?=is_select("kategori_konten","id_kategori","id","nama_kategori","$id_kategori");?>
                    </div>

                    <div class="form-group">
                        <label>Nama Galeri</label>
                        <input type="text" class="form-control form-control-sm" placeholder="Nama Galeri"
                            name="nama_galeri" id="nama_galeri" value="<?=$nama_galeri?>" maxlength="50">
                    </div>

                    <div class="form-group">
                        <label>Deskripsi kegiatan</label>
                        <textarea class="form-control form-control-sm" placeholder="Deskripsi kegiatan"
                            name="deskripsi_kegiatan" id="deskripsi_kegiatan" rows="3"
                            cols="80"><?=$deskripsi_kegiatan?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-xs-12">
                            ...
                            <input type="text" class="form-control form-control-sm file-upload-info file-name"
                                data-id="cover" placeholder="Cover" readonly name="cover" value="<?=$cover?>" />
            ...
            --->
                        <?=is_select("stts","status_galeri","id","keterangan","$status_galeri");?>
                    </div>
