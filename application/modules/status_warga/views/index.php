<div class="row">
  <div class="col-md-12 col-xl-12 mx-auto animated fadeIn delay-2s">
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <div class="mb-2">
          <a href="<?=url("status_warga/add")?>" class="btn btn-sm btn-success btn-icon-text"><i class="fa fa-file btn-icon-prepend"></i><?=cclang("add_new")?></a>
          ...
          <a href="<?=url("status_warga/filter/")?>" id="filter-show" class="btn btn-sm btn-primary btn-icon-text"><i class="mdi mdi-magnify btn-icon-prepend"></i> Filter</a>
        </div>

        <form autocomplete="off" class="content-filter">
          <div class="row">
            <div class="form-group col-md-6">
              <input type="text" id="nama_stts_warga" class="form-control form-control-sm" placeholder="Nama Status Warga" />
            </div>
...
//datatables
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": "<?= url("status_warga/json")?>",
          "type": "POST",
          "data":function(data){
              data.nama_stts_warga = $("#nama_stts_warga").val();
              }
            },
