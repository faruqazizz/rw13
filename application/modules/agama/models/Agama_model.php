...
class Agama_model extends MY_Model{
  ...
  private $order        = array('agama.id'=>"DESC");
  private $select       = "agama.id,agama.nama";
...
public function __construct()
  ...
  private function _get_datatables_query()
    ...
    if($this->input->post("nama"))
        {
          $this->db->like("agama.nama", $this->input->post("nama"));
        }
...
/* Location: ./application/modules/agama/models/Agama_model.php */
