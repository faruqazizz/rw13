...
class Kelamin_model extends MY_Model{
  ...
  private $table        = "kelamin";
  private $primary_key  = "id";
  private $column_order = array('nama');
  private $order        = array('kelamin.id'=>"DESC");
  private $select       = "kelamin.id,kelamin.nama";
...
public function __construct()
  ...
  private function _get_datatables_query()
    ...
    if($this->input->post("nama"))
        {
          $this->db->like("kelamin.nama", $this->input->post("nama"));
        }
...
/* Location: ./application/modules/kelamin/models/Kelamin_model.php */
