      ...
      <div class="card-body">
        <div class="mb-1">
          ...
          <a href="<?=url("filemanager/delete")?>" id="delete_select" class="btn btn-sm btn-danger btn-icon-text"><i class="ti-trash btn-icon-prepend"></i> <?=cclang("delete_selected")?></a>
		      <a href="<?= url("filemanager/cek_gambar")?>" class="btn btn-sm btn-dark btn-icon-text"><i class="ti-reload btn-icon-prepend"></i>Sinkronisasi File</a>
          <?php if(profile('id_group') == 1){ ?>
		      <a href="<?= url("filemanager/bersihkan_tabel")?>" id="delete_select" class="btn btn-sm btn-warning btn-icon-text"><i class="ti-alert btn-icon-prepend"></i>Bersihkan Tabel</a>
          <?php } ?>
        </div>

        <div class="table-responsive">
          <table class="table table-bordered table-striped" id="tabelku" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
            <thead>
              <tr>
                <th>#</th>
                <th>Image</th>
