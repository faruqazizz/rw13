...
class Pengaturan_model extends MY_Model{
  ...
  private $column_order = array('deskripsi_web', 'alamat_gmaps', 'visi', 'misi', 'foto', 'header', 'marquee', 'tagline', 'motto', 'tujuan');
  private $order        = array('pengaturan.id'=>"DESC");
  private $select       = "pengaturan.id,pengaturan.deskripsi_web,pengaturan.alamat_gmaps,pengaturan.visi,pengaturan.misi,pengaturan.foto,pengaturan.header,pengaturan.marquee,pengaturan.tagline,pengaturan.motto,pengaturan.tujuan";
