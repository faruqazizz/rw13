...
class Slider_model extends MY_Model{
  ...
  private $column_order = array('judul_foto', 'lokasi_foto', 'id_stts');
  private $order        = array('slider.id'=>"DESC");
  private $select       = "slider.id,slider.judul_foto,slider.lokasi_foto,slider.id_stts";
...
public function __construct()
  ...
  private function _get_datatables_query()
    ...
    if($this->input->post("judul_foto"))
        {
          $this->db->like("slider.judul_foto", $this->input->post("judul_foto"));
        }

    if($this->input->post("lokasi_foto"))
        {
          $this->db->like("slider.lokasi_foto", $this->input->post("lokasi_foto"));
        }

    if($this->input->post("id_stts"))
        {
          $this->db->like("slider.id_stts", $this->input->post("id_stts"));
        }
    ...
    public function _get_join()
    {
      ...
      $this->db->join("stts","stts.id = slider.id_stts","left");
    }
...
/* Location: ./application/modules/slider/models/Slider_model.php */
