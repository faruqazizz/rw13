<div class="row">
  <div class="col-md-12 col-xl-12 mx-auto animated fadeIn delay-2s">
    <div class="card m-b-30">
      ...
      <div class="card-body">
        <div class="mb-2">
          <a href="<?=url("menu_frontend/add")?>" class="btn btn-sm btn-success btn-icon-text"><i class="fa fa-file btn-icon-prepend"></i><?=cclang("add_new")?></a>
          ...
          <a href="<?=url("menu_frontend/filter/")?>" id="filter-show" class="btn btn-sm btn-primary btn-icon-text"><i class="mdi mdi-magnify btn-icon-prepend"></i> Filter</a>
        </div>

        <form autocomplete="off" class="content-filter">
          <div class="row">
            <div class="form-group col-md-6">
              <input type="text" id="nama_menu" class="form-control form-control-sm" placeholder="Nama Menu" />
            </div>

            <div class="form-group col-md-6">
              <input type="text" id="tautan_menu" class="form-control form-control-sm" placeholder="Tautan menu" />
            </div>
            ...
            <div class="form-group col-md-6">
                        ...
                        --->
                <?=is_select_filter("menu_halaman","id_halaman","id","nama_halaman","Halaman Menu");?>
            </div>
...
//datatables
  table = $('#table').DataTable({
      ...
      "ajax": {
          "url": "<?= url("menu_frontend/json")?>",
          "type": "POST",
          "data":function(data){
              data.nama_menu = $("#nama_menu").val();
              data.tautan_menu = $("#tautan_menu").val();
              data.id_halaman = $("#id_halaman").val();
              }
            },
