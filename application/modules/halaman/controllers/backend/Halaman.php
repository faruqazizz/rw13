    ...
    foreach ($list as $row) {
        ...
        $rows[] = '
                  <div class="btn-group" role="group" aria-label="Basic example">
                      <a href="'.url("halaman/detail/".enc_url($row->id)).'" id="detail" class="btn btn-primary" title="'.cclang("detail").'">
                        <i class="mdi mdi-file"></i>
                      </a>
                      <a href="'.url("halaman/update/".enc_url($row->id)).'" id="update" class="btn btn-warning" title="'.cclang("update").'">
                        <i class="ti-pencil"></i>
                      </a>
                      <a href="'.url("halaman/delete/".enc_url($row->id)).'" id="delete" class="btn btn-danger" title="'.cclang("delete").'">
                        <i class="ti-trash"></i>
                      </a>
                    </div>
                 ';
...
function detail($id)
{
  $this->is_allowed('halaman_detail');
...
function add()
{
  ...
  $data = array('action' => url("halaman/add_action"),
...
function update($id)
{
  ...
  if ($row = $this->model->find(dec_url($id))) {
    ...
    $data = array('action' => url("halaman/update_action/$id"),
...
/* Location: ./application/modules/halaman/controllers/backend/Halaman.php */
