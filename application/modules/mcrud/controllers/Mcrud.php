...
class Mcrud extends Backend{
  ...
  function action()
  {
    if ($this->input->is_ajax_request()) {
      ...
      $this->form_validation->set_rules('controllers', 'Controllers - ', 'trim|required|callback__cek_dir');
  ...
  function form_type_group()
  {
    $group = array(
      array(
        "validation" => "required",
        "group"      => "text,textarea,select,password,text_editor,upload_image,upload_document,select,option,select_relation,option_relation,date,time,datetime,number"
      ),
