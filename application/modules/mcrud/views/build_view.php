...
<?php elseif (formType($field) == "upload_document"): ?>
        <tr>
          <td><?=label($field)?></td>
          <td><a href="<?= base_url("_temp/uploads/img/") ?>{php_open_tag_echo}$<?=$field?>{php_close_tag}" target="_blank">{php_open_tag_echo}$<?=$field?>{php_close_tag}</a></td>
        </tr>
