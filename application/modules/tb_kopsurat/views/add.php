        ...
        <form action="<?=$action?>" id="form" autocomplete="off">
            ...
            <?=is_combo("auth_group","id_group","id","group",$id_group,">=","4")?>
                ...
                <div class="input-group col-xs-12">
                  ...
                  <input type="text" class="form-control form-control-sm file-upload-info file-name" data-id="gambar_kop" placeholder="Gambar Kop" readonly name="gambar_kop" />
                ...
                <label>RT Berapa</label>
                                            <input type="text" class="form-control form-control-sm" placeholder="RT Berapa" name="nama" id="nama">
                                          </div>
