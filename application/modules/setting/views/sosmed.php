      ...
      <div class="card-body">
        ...
        <?php if (is_allowed("config_view_sosmed")) : ?>
          <table class="table-setting table-striped table-hover">
            ...
            <tr>
              <td class="table-title"><i class="ti-music cl-music"></i> Tiktok</td>
              <td>
                <a href="javascript:void(0);" id="tiktok" data-url="<?= url("setting/update_action") ?>" data-type="text" data-pk="54" class="editable editable-click" title="<?= cclang("update") ?>"><?= setting('tiktok') ?></a>
              </td>
            </tr>
          </table>
        <?php else : ?>
