...
<?php } ?>
            <tr>
            <td class="table-title">Email otomatis</td>
            <td>
              <a href="javascript:void(0);" id="emailnya" data-url="<?=url("setting/update_action")?>" data-type="text" data-pk="10" class="editable editable-click" title="<?=cclang("update")?>"><?=setting('emailnya')?></a>
            </td>
          </tr>
